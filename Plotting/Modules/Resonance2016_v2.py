def config_samples(samples) :
    ...
    samples.AddSample('WGToLNuG-amcatnloFXFXPhCut',
                      ...
                      #path='WGToLNuG_01J_5f_TuneCUETP8M1_13TeV-amcatnloFXFX-pythia8PhCutMax',
    ...
    samples.AddSample('MadGraphResonanceMass450_width5', path='MadGraphChargedResonance_WGToLNu_M450_width5', isActive=False, isSignal=True, useXSFile=True, plotColor=ROOT.kBlue, legend_name = '#Phi^{#pm} #rightarrow W^{#pm}#gamma, M = 450 GeV', XSName='ResonanceMass450') #NOTE:Acitve
    ...
    samples.AddSample('MadGraphResonanceMass600_width0p01', path='MadGraphChargedResonance_WGToLNu_M600_width0p01', isActive=False, isSignal=True, useXSFile=True, plotColor=ROOT.kGreen, legend_name = '#Phi^{#pm} #rightarrow W^{#pm}#gamma, M = 600 GeV', XSName='ResonanceMass600')
    ...
    samples.AddSample('MadGraphResonanceMass700_width0p01', path='MadGraphChargedResonance_WGToLNu_M700_width0p01', isActive=False, isSignal=True, useXSFile=True, plotColor=ROOT.kRed, legend_name = '#Phi^{#pm} #rightarrow W^{#pm}#gamma, M = 700 GeV', XSName='ResonanceMass700') ##NOTE
    ...
    samples.AddSample('MadGraphResonanceMass1000_width5', path='MadGraphChargedResonance_WGToLNu_M1000_width5', isActive=False, isSignal=True, useXSFile=True, plotColor=ROOT.kBlack, legend_name = '#Phi^{#pm} #rightarrow W^{#pm}#gamma, M = 1000 GeV', XSName='ResonanceMass1000') #NOTE: Active signal
...
#    samples.AddSample('QCD_Pt-15to20_EMEnriched', path='QCD_Pt-15to20_EMEnriched_TuneCUETP8M1_13TeV_pythia8', isActive=False, useXSFile=True)
    ...
    samples.AddSample('QCD_Pt-30to40_DoubleEMEnriched_MGG-80toInf', path='QCD_Pt-30to40_DoubleEMEnriched_MGG-80toInf_TuneCUETP8M1_13TeV_Pythia8', isActive=False, useXSFile=True)
    ...
    samples.AddSample('QCD_Pt-30toInf_DoubleEMEnriched_MGG-40to80', path='QCD_Pt-30toInf_DoubleEMEnriched_MGG-40to80_TuneCUETP8M1_13TeV_Pythia8', isActive=False, useXSFile=True)
    samples.AddSample('QCD_Pt-40toInf_DoubleEMEnriched_MGG-80toInf', path='QCD_Pt-40toInf_DoubleEMEnriched_MGG-80toInf_TuneCUETP8M1_13TeV_Pythia8', isActive=False, useXSFile=True)
    ...
    samples.AddSample('QCD_Pt-170to300_MuEnrichedPt5', path='QCD_Pt-170to300_MuEnrichedPt5_TuneCUETP8M1_13TeV_pythia8', isActive=False, useXSFile=True)
